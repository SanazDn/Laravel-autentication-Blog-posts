...
<html lang="en" class="mb-0">
  ...
  <body >
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        ...
        <div class="flex-row my-3 my-md-0">
          ...
          <a class="btn btn-sm btn-success mr-2" href="/create-meet">Create Meetup</a>
          <form action="/logout" method="POST" class="d-inline">
            @csrf
            <button class="btn btn-sm btn-secondary">Sign Out</button>
          </form>
        </div>
        {{--  if a user loged out -->  @else --}}
        @else
    ...
    <!-- header ends here -->
{{-- flesh message after login and logout and .... --}}
    ...
    <script>
        // Add JavaScript to hide the success message after 10 seconds
    ...
    <!-- footer begins -->
    {{-- <footer class="border-top text-center small text-muted py-3 custom-footer mb-0"> --}}
        @auth
    <footer>
